...
\midrule
ContextBench Verified            & \emph{500}  & 0.739 & \emph{pending} & \emph{pending} & \emph{pending} \\
PolyBench-500                    & \emph{500}  & 0.847 & \emph{pending} & \emph{pending} & \emph{pending} \\
SWE-bench Verified               & 500         & 0.913 & 0.657          & \emph{TBD}     & \emph{TBD} \\
\textbf{Pooled}                  & \emph{1500} & \textbf{0.833} & \emph{pending} & \emph{pending} & \emph{pending} \\
\midrule
