...
to select the most important context within a token budget.
Understands imports, type references, config dependencies, and
co-change patterns across 13+ programming languages.
